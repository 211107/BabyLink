...
const Lista04 = () => {
  const [vacunas, setVacunas] = useState({
    ...
    HepatitisB2: false,
    Rotavirus1: false,
    NeumococoConjugada: false,
    PentavalenteAcelular2: false,
    Rotavirus2: false,
    NeumococoConjugada2: false,
  });
  ...
  //obtener id del bebe del local storage
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.textHeader}>Vacunas de 0 a 4 Meses</Text>

      {/* {Object.keys(vacunas).map(key => (
        <View key={key} style={styles.row}>
          ...
          <View style={styles.checkboxWrapper}>{renderCheckbox(key)}</View>
        </View>
      ))} */}
